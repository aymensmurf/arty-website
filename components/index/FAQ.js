		...
		<>
				...
				<div className='container'>
					<div className='faq-container'>
						...
						<p className='description'>
							These are the most frequently asked questions, if you have another thing on mind{" "}
							<a onClick={openContact}>get in touch</a>
						</p>
						...
						<div style={{ marginTop: 70 }}>
							<Accordion
								...
								a={
									<p>
										ARTY is a social network for artists, art enthusiast, and amateurs, designed to enhance connectivity
										between the creative arts communities and offers fast reliable online solutions to organize events
										and workshops.
									</p>
								}
							/>
							<Accordion
								...
								a={
									<p>
										ARTY is a product ideated, designed, and developed by Innovant, a Startup that combines both worlds
										of arts, design and the top notch software development.
									</p>
								}
							/>
							<Accordion q='How can I join ARTY?' a={<p>Contact us and we will send you a TestFlight link.</p>} />
						</div>
						<a name='download'></a>
					...
					<h1 className='slogan' style={{ overflow: "hidden", marginTop: 180 }}>
						...
						<span className='word-container-bottom' style={{ zIndex: 1 }}>
							{WORDS[wordIndex]}
						</span>
						&nbsp;
					</h1>
			...
			<style jsx>{`
				...
				.faq-container {
					...
					box-shadow: inset 0px 2000px 0px 0 rgb(0, 0, 0, 0.2);
					padding: 70px 250px;
					border-radius: 25px;
					text-align: center;
				}
