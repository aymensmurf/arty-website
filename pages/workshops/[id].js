		...
		<>
			<Head>
				...
				<meta
					name="description"
					content={
						data.description ? data.description : "Connect, aspire and inspire"
					}
				/>
				...
				<meta
					property="og:image"
					content={data.banner ? getImageUri(data.banner) : "/img/singers.svg"}
				/>
				<meta property="og:type" content="website" />

				<meta
					property="twitter:title"
					content={data.title ? data.title : "Arty"}
				/>
				<meta
